...
export default function DeleteButtonPrivateFactor() {
  ...
  const handleDelete = async () => {
    ...
    try {
      await deletePrivateEmission({ ids: selectedItems });
            ...
            <>
              ...
              <ModalBody>
                <p className='font-medium'>
                  This action cannot be undone. This will permanently delete your emission factor.
                </p>
              </ModalBody>
              <ModalFooter>
                ...
                <Button onClick={handleDelete} className="text-white bg-indigo-500 hover:bg-indigo-600 cursor-pointer">
                  Confirm
                </Button>
              </ModalFooter>
            </>
