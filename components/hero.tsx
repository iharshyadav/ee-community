          ...
          <div className="relative max-w-xl mx-auto md:max-w-none text-center md:text-left flex flex-col md:flex-row">
            ...
            <div className="md:w-[48rem]">
              ...
              <div className="md:pr-32">
                <h1 className="h2 font-aspekta bg-clip-text text-transparent bg-gradient-to-tr from-green-500 via-sky-300 to-slate-200 pb-6">
                  A community of makers to simplify CSRD reporting journey
                </h1>
                <p className="text-lg text-slate-400 mb-8">
                  Be part of our journey towards a sustainable future with
                  engaging CSRD reporting.
                </p>
              </div>
              {/* Logos */}
              <div className="md:flex flex-wrap items-center md:space-x-5 text-center">
                ...
                <div className="mb-4 md:mb-0">
                  <div className="text-sm italic text-slate-500 whitespace-nowrap">
                    Catch up with founders from
                  </div>
                </div>
