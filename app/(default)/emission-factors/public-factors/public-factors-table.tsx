...
import PrivateFactorsTableItem from "./public-factors-table-item";
...
export default function PrivateFactorsTable({
  ...
  return (
    <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 relative shadow-sm rounded-xl">
