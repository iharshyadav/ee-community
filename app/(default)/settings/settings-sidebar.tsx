    ...
    <div className="flex flex-nowrap overflow-x-scroll no-scrollbar md:block md:overflow-auto px-3 py-6 border-b md:border-b-0 md:border-r border-gray-200 dark:border-gray-700/60 min-w-[15rem] md:space-y-3">
      ...
      <div>
        ...
        <ul className="flex flex-nowrap md:block mr-3 md:mr-0">
          <li className="mr-0.5 md:mr-0 md:mb-0.5">
            <Link
              ...
              className={`flex items-center px-2.5 py-2 rounded-lg whitespace-nowrap ${
                ...
                "bg-[linear-gradient(135deg,var(--tw-gradient-stops))] from-green-500/[0.12] dark:from-green-500/[0.24] to-green-500/[0.04]"
              }`}
            >
              <svg
          ...
          <li className="mr-0.5 md:mr-0 md:mb-0.5">
            <Link
              href="/settings/invite-teams"
              className={`flex items-center px-2.5 py-2 rounded whitespace-nowrap ${
                pathname.includes("/settings/invite-teams") &&
                "bg-[linear-gradient(135deg,var(--tw-gradient-stops))] from-green-500/[0.12] dark:from-green-500/[0.24] to-green-500/[0.04]"
              }`}
            >
              <svg
          ...
          <li className="mr-0.5 md:mr-0 md:mb-0.5">
            <Link
              href="/settings/teams-member"
              className={`flex items-center px-2.5 py-2 rounded whitespace-nowrap ${
                pathname.includes("/settings/teams-member") &&
                "bg-[linear-gradient(135deg,var(--tw-gradient-stops))] from-green-500/[0.12] dark:from-green-500/[0.24] to-green-500/[0.04]"
              }`}
            >
              <svg
