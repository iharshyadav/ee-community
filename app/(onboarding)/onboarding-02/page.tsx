                ...
                <form onSubmit={handleSubmit}>
                  <div className="sm:flex space-y-3 sm:space-y-0 sm:space-x-4 mb-8">
                    <label className="flex-1 relative block cursor-pointer">
                      ...
                      <div
                        className="absolute inset-0 border-2 border-transparent peer-checked:border-green-400 dark:peer-checked:border-green-500 rounded pointer-events-none"
                        aria-hidden="true"
                      ></div>
                    </label>
                    <label className="flex-1 relative block cursor-pointer">
                  ...
                  <div className="flex items-center justify-between space-x-6 mb-8">
                    <div>
                      <div className="font-medium text-slate-800 dark:text-slate-100 text-sm mb-1">
                        💸 Do you want us to remove the data after 30 days?
                      </div>
                      <div className="text-xs">
                        Your data is stored in accordance with the General Data
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      type="submit"
                      className="btn bg-black hover:bg-black text-white ml-auto"
                    >
                      Next Step -&gt;
                    </button>
                  </div>
